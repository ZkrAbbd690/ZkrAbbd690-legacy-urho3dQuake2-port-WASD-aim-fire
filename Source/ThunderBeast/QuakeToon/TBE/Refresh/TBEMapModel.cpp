...
Clears the material lookup cache to prevent access to destroyed Urho3D context.
================
*/
void Mod_MapModel_Shutdown(void)
{
    // Clear material cache
    materialLookup.Clear();

    // Release all global SharedPtrs before Urho3D Context dies
    scene_.Reset();
    cameraNode_.Reset();
}
